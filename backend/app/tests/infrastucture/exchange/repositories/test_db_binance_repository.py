...
from app.infrastructure.exchange.repositories.db_binance_repository import DbBinanceRepository
...
class TestDbBinanceRepository(TestCase):
    def setUp(self) -> None:
        ...
        self.repository = DbBinanceRepository()

    @patch("app.infrastructure.exchange.repositories.db_binance_repository.get_session")
    def test_find_exchange(self, get_session: Mock) -> None:
        ...
        result = self.repository.find_exchange()
    ...
    def test_find_exchange_fetching_tickers(self, get_session: Mock) -> None:
        ...
        result = self.repository.find_exchange(fetch_tickers=True)
    ...
    def test_find_exchange_not_found(self, get_session: Mock) -> None:
        ...
        with self.assertRaisesRegex(ExchangeNotFoundException, "exchange with name 'Binance' not found'"):
            self.repository.find_exchange()
