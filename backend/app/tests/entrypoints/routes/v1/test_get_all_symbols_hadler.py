...
class TestGetAllSymbolsHandler(TestCase):
    ...
    def test_handle(self, logger: Mock) -> None:
        ...
        self.get_all_symbols_query.execute.return_value = GetAllSymbolsQueryResponse(symbols=domain_schemas)
    ...
    def test_handle_unexpected_error(self, logger: Mock) -> None:
        ...
        with self.assertRaises(HTTPException) as e:
            ...
            logger.error.assert_called_once_with(f"An unexpected error happened while retrieving all symbols: {e.exception}")
